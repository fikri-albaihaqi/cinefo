...
// Movies
export const getMovies = (category = 'popular', page = 1) => axios.get(`${url}/movie/${category}?api_key=${apiKey}&page=${page}`);
...
// TV Shows
export const getTvShows = (category = popular, page = 1) => axios.get(`${url}/tv/${category}?api_key=${apiKey}&page=${page}`);
